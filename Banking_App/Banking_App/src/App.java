...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        while (true) { 
            ...
            System.out.println("Enter 1 for depositing or 2 for withdrawing or 0 in order to exit menu");
            ...
            switch (menuOption) {
                case 1://invoking deposit method of class
                    ...
                    System.out.println("Succesful depositing.Current account balance: " + account.getBalance());
                        ...
                        System.out.println("Depositing amount cannot be <= 0");
                    }
                    break;
                case 2://invoking withdrawing method of class
                    ...
                    System.out.println("Withdrawing succesful. Current account balance:" + account.getBalance());
                    }
                    catch(IllegalArgumentException e){
                        System.out.println("Withdrawing amount cannot be <= 0");
                    }
